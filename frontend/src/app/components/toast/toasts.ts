...
@Component({
  ...
  styles: [`
    ...
    .toast{background:#0b1220; color:#eaf2ff; border:1px solid #1d2939; padding:10px 12px; border-radius:10px; box-shadow:0 8px 24px rgba(2,6,23,.32)}
    .toast.ok{border-color:#2dd4bf}
